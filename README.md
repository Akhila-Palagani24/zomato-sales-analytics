...
Shows the monthly net revenue trend from 2023 to 2025.
...
### 2. Revenue by City
Compares the total revenue generated by each city.

![Revenue by City](visuals/02_revenue_by_city.png)

---

### 3. Revenue by Region
Displays revenue contribution from different regions.

![Revenue by Region](visuals/03_revenue_by_region.png)

---

### 4. Revenue by Food Category
Shows the revenue generated by each food category.

![Revenue by Food Category](visuals/04_revenue_by_category.png)
